    ...
    public function run(): void
    {
        ...
        $dataPR = [
            ...
            [
                ...
                'social_media_link' => 'https://www.instagram.com/reel/DZH1TywDYU3/?utm_source=ig_web_copy_link&igsh=NTc4MTIwNjQ2YQ==',
                'outlet_id' => $outlet->id,
                'status' => 'paid',
                'created_by' => $staff->id,
            ...
            [
                ...
                'social_media_link' => 'https://youtu.be/TiUtj8e6uAI?si=fU5WlcQUWKXjFU34',
                'outlet_id' => $outlet->id,
                'status' => 'approved',
                'created_by' => $staff->id,
                'approved_by' => $manager->id,
            ...
            [
                ...
                'social_media_link' => 'https://youtu.be/ieP36lytkeQ?si=lPFuUYI3HcZIOANN',
                'outlet_id' => $outlet->id,
                'status' => 'submitted',
                'created_by' => $staff->id,
                'approved_by' => null,
            ...
            [
                ...
                'social_media_link' => 'https://www.instagram.com/p/DZKHzy2mcrz/?utm_source=ig_web_copy_link&igsh=NTc4MTIwNjQ2YQ==',
                'outlet_id' => $outlet->id,
                'status' => 'draft',
                'created_by' => $staff->id,
                'approved_by' => null,
            ...
            [
                ...
                'social_media_link' => 'https://youtu.be/5bKxkW_z408?si=ePTInAmFeWdQUPL3',
                'outlet_id' => $outlet->id,
                'status' => 'rejected',
                'created_by' => $staff->id,
                'approved_by' => $manager->id,
            ...
            [
                ...
                'social_media_link' => 'https://youtu.be/YKGCCS1j43M?si=-2kop5n4TwTrIKeL',
                'outlet_id' => $outlet->id,
                'status' => 'paid',
                'created_by' => $staff->id,
                'approved_by' => $manager->id,
